...
const SignUpLoginNavbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-4 px-6 bg-gradient-to-r text-black w-full'>
            <Link className='flex items-center transition-transform duration-300 hover:scale-105'>
            ...
            <div className='flex items-center gap-6'>
                <Link
                    to='/login'
                    className='relative flex items-center gap-2 text-green-400 hover:text-cyan-400 font-medium transition-all duration-300 overflow-hidden group'
