...
const SignUpLoginNavbar = () => {
    ...
    return (
        <div className='flex items-center justify-end py-5 px-1 bg-gradient-to-r text-black w-full'>
            <div className='flex items-center gap-6'>
                ...
                >
                    <LogIn size={16} className={`transition-all duration-300 ${hoverButton === 'login' ? 'rotate-12' : ''}`} />
                ...
                <NavLink
                    ...
                    onMouseLeave={() => setHoverButton(null)}
                >
                    <User size={16} className={`transition-all duration-300 ${hoverButton === 'signup' ? 'rotate-12' : ''}`} />
